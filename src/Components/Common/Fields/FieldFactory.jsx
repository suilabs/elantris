...
import { SuiHeroImage, SuiImage, SuiParagraph, SuiTag, SuiTitle, StickyText } from '../../../ComponentsLib';

const componentTypes = [SuiHeroImage, SuiImage, SuiParagraph, SuiTag, SuiTitle, StickyText];
